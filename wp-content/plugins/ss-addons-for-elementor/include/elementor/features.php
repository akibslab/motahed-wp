    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('Service Description', 'ss-addons'),
                'rows' => 3,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .feature_inner .feature_text .desc' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .feature_inner .feature_text .desc',
            ]
        );
        $this->add_responsive_control(
            'desc_padding',
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .feature_inner .feature_text .desc' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .feature_inner .feature_text .desc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
                                ...
                                <div class="single_feature">
                                    <div class="feature_inner">
                                        ...
                                        <div class="feature_text">
                                            ...
                                            <?php endif; ?>
                                            <?php if (!empty($feature['ss_features_description'])) : ?>
                                                <p class="desc"><?php echo ss_kses($feature['ss_features_description']); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
