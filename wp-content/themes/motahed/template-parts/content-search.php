...
if (is_single()) : ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class('ss__post format-search'); ?>>
        ...
        <div class="ss__content">
            ...
            <div class="post-text">
                ...
                <?php
                wp_link_pages([
                    'before'      => '<div class="ss-page__links"> <span class="ss-page-links__title">' . esc_html__('Pages:', 'motahed') . '</span>',
                    'after'       => '</div>',
                    'link_before' => '<span>',
                    'link_after'  => '</span>',
                    'pagelink'    => '<span class="screen-reader-text">' . esc_html__('Page', 'motahed') . ' </span>%',
...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ss-post__grid format-search'); ?>>
